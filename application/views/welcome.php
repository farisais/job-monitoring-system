...
<body class="login">
<div id="login">
	<h1 style="text-align: center;margin-left:20px;"><img src="<?php echo base_url('/images/nobi-logo.png')?>" width="150"></img></h1>
	<p style="text-align: center;color:navy; opacity: 0.8;font-size: 14px;"><b>Job Monitoring System Login</b></p>
	<form name="loginform" id="loginform" action="<?php echo base_url('login/log_me_in');?>" method="post">
		...
		<p>
			<label>
				<select name="job_type" class="ui-widget-content ui-corner-all">
